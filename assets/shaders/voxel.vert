...
layout(location = 5) in int a_atlas_id; // Atlas ID (0=main, 1=side, 2=bottom)
...
flat out int v_atlas_id; // Pass atlas ID to fragment shader (flat for integer)
...
void main() {
    ...
    v_atlas_id = a_atlas_id; // Pass atlas ID to fragment shader
}
