...
### Phase 1: World Creation Interface
**Goal**: Implement world generation parameter selection

#### 1.1 World Generation Wizard
- **New World Dialog**: Multi-step world creation process
- **Seed Input**: Text field for entering custom seeds, with random generation button
- **World Size Selection**: Dropdown or slider for world scale options
- **Generation Presets**: Quick-select options (Rich, Normal, Harsh, Custom)
- **Advanced Parameters**: Expandable section for detailed control

#### 1.2 Scalable World Size Selection
- **Size Categories**: Starter, Regional, Continental, Massive (with descriptions)
- **Size Visualization**: Comparative map showing relative sizes
- **Performance Warnings**: Clear indicators for generation time and RAM requirements
- **Grayed-Out Options**: Massive world sizes unavailable until optimization complete
- **Recommendation System**: Suggest appropriate sizes based on player experience

**World Size Interface**:
```
┌─ World Size Selection ─────────────────────────────┐
│                                                    │
│  ○ Starter (10km²)     │ ○ Regional (1,000km²)     │
│    ~5 seconds          │   ~30 seconds             │
│    Recommended         │   Standard                │
│                        │                           │
│  ○ Continental         │ ○ Massive (25,000,000km²) │
│    (100,000km²)        │   ~2 hours                │
│    ~10 minutes         │   [COMING SOON - GRAYED]  │
│    Advanced            │   Requires optimization   │
│                        │                           │
└────────────────────────────────────────────────────┘
```
...
- **Terrain Parameters**: Height variation, erosion intensity, water levels
- **Biome Controls**: Climate variation, biome size, transition sharpness
- **Resource Abundance**: Sliders for ore density, forest coverage, etc.
- **Challenge Settings**: Hostile creature frequency, natural disaster intensity
- **Special Features**: Enable/disable caves, ruins, special formations

#### 1.5 Two-Tier Generation Preview
...
- **Seed Sharing**: Copy/paste world seeds for sharing with other players

### Phase 2: World Viewer Interface
**Goal**: Implement comprehensive world exploration before settlement

#### 2.1 World Overview Map
...
- **Layer Toggles**: Switch between terrain, biomes, resources, features
