...
- **Mini-Map Preview**: Small heightmap preview updating as parameters change
- **Statistics Display**: Show expected resource levels, terrain variety, etc.
- **Generation Time Estimate**: Predict how long full world generation will take
