...
- [ ] **Fix Greedy Mesh Texture Tiling**
    - See sub-task: [03.2_fix_greedy_mesh_texture_tiling.md](./03.2_fix_greedy_mesh_texture_tiling.md)
    - Date Logged: 2025-05-14
    - Symptoms: Textures on large faces generated by greedy meshing are stretched instead of tiled. The specific voxel texture (e.g., stone) should repeat across the face, not the entire atlas.
